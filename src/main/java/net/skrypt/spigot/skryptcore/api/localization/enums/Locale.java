/*
 * Copyright (c) 2016 Skrypt _ All Rights Reserved.
 *
 * Web: www.skrypt.net
 * E_Mail: contact@skrypt.net
 *
 * Illegal modification and redistribution is not allowed.
 */

package net.skrypt.spigot.skryptcore.api.localization.enums;
...
public enum Locale {
	...
	Locale(String fullName) {
		this.fullName = fullName;
	}

	public static Locale fromString(String locale) {
		for (Locale loc : Locale.values()) {
			if (loc.name().equalsIgnoreCase(locale)) {
				return loc;
			}
		}
		return null;
